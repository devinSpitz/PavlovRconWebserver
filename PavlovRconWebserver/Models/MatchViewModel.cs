...
namespace PavlovRconWebserver.Models
{
    ...
    {
        [BsonIgnore] [NotMapped] public List<Team> AllTeams { get; set; }

        [BsonIgnore] [NotMapped] public int? Team0Id { get; set; }

        [BsonIgnore] [NotMapped] public int? Team1Id { get; set; }

        [BsonIgnore] [NotMapped] public List<PavlovServer> AllPavlovServers { get; set; }
