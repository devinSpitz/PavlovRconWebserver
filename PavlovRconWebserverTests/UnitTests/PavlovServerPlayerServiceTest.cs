...
namespace PavlovRconWebserverTests.UnitTests
{
    public class PavlovServerPlayerServiceTest
    {
        ...
        public static PavlovServerPlayer CreatePavlovServerPlayer(PavlovServerPlayerService pavlovServerPlayerService,int pavlovServerId)
        {
            ...
            return pavlovServerPlayerService.FindAllFromServer(pavlovServerId).GetAwaiter().GetResult().FirstOrDefault();
        }
        ...
        public void FindAllFromServer()
        {
            ...
            // act
            var serverResult = _pavlovServerPlayerService.FindAllFromServer(pavlovServers.First().Id).GetAwaiter().GetResult();
            // assert
